        ...
        <div class="col-md-9">
            ...
            <div class="profile-pic pro-dd">
                ...
                <div class="div-pro-dd">
                    ...
                    <?php if(end($imgarr)=='pdf'): ?>
                        <iframe src="<?php echo e(asset($allimage->image)); ?>" class="iframe_pdf" frameborder="0"></iframe>
                    <?php elseif(end($imgarr)=='ai'): ?>
                        <img src="<?php echo e(asset($allimage->image)); ?>" class="iframe_ai" alt="Profile picture" >
                    <?php else: ?>
...
<?php echo $__env->make('company.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/sortiment/resources/views/company/company-information.blade.php ENDPATH**/ ?>