                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="category_ids[]" id="category_ids" class="form-control select2" multiple require>
                                                    ...
                                                    <?php $selected = in_array($category->id,$ProductCategory) ? "selected" : ""; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="subcategory_ids[]" class="form-control select2" multiple id="subcategory_id">
                                                    ...
                                                    <?php $selected = in_array($subcategory->id,$ProductSubCategory) ? "selected" : ""; ?>
                                                    <option value="<?php echo e($subcategory->id); ?>" 
                                                       <?php echo e($selected); ?>

                                                    ><?php echo e($subcategory->subcategory_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php $__errorArgs = ['subcategory_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\sortiment\resources\views/backend/product/edit.blade.php ENDPATH**/ ?>