                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        <td class="fs-20" style="font-size: 30px; font-weight: 600; color: #ffffff; padding-bottom: 15px;">
                            <?php echo e(__('Konto godkendt')); ?>

                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            <?php echo e(__('Du har fornylig oprettet en konto på Sortiment.dk - din konto er nu godkendt og du kan nu bestille produkter via shoppen.')); ?>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        <td class="fs-20" style="font-size: 30px; font-weight: 700; padding-bottom: 5px;">Dine konto oplysninger</td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <a href="<?php echo e(url('/')); ?>" style="width: 100%; background-color: #001FD1; color: #ffffff; padding-top: 20px; padding-bottom: 20px; font-size: 25px; font-weight: 600; border-radius: 5px; margin-top: 15px; display: block; text-decoration: none; text-align: center;"><?php echo e(__('Log ind')); ?></a>
                        </td>
                    </tr>
                </table>
            </td>
...
<?php /**PATH C:\xampp\htdocs\laravel\sortiment\resources\views/mail/company-approval.blade.php ENDPATH**/ ?>