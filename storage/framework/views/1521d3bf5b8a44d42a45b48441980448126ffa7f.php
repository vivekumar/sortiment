...
<head>
    ...
    <title><?php echo e(__('Shipping Order')); ?></title>
</head>
            ...
            <td colspan="3">
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        ...
                        <?php echo e(__('Your order is being shipped')); ?>.
                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                        <?php echo e(__('We have now shipped your order')); ?>   .
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <p><strong style="font-size: 18px;"><small style="color: #001FD1; font-size: 18px;"><?php echo e(('Total costs')); ?>:</small> <?php echo e($order['amount']+$order['delivery_costs']); ?> DKK</strong></p>
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td><p><strong><?php echo e(__('Shipping order')); ?></strong><br> <small><?php echo e(__('Your order is being shipped')); ?>.</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <a href="<?php echo e($order['tracking_url']); ?>" style="background-color: #001FD1; color: #ffffff;display: inline-block; padding: 12px 12px; margin-bottom:5px; border-radius: 5px; text-decoration: none; text-align: center; vertical-align: top;"><?php echo e(__('Track delivery')); ?></a>
                                        <?php endif; ?>
                                        <?php if(!empty($order['pdf'])): ?>
                                        
                                        <a href="<?php echo e(asset($order['pdf'])); ?>" style="background-color: #001FD1; display: inline-block; padding: 5px 10px; border-radius: 5px; margin-bottom:5px; text-align: center;"><img src="<?php echo e($message->embed('public/frontend/mail/img/file-pdf-solid.png')); ?>" alt="" width="20" download></a>
                                        <?php endif; ?>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/shipping-order.blade.php ENDPATH**/ ?>