  ...
  <!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
		...
		<td width="30%">
			...
			<?php if($item->status == 1): ?>
				<a href="<?php echo e(route('cproduct.inactive',$item->id)); ?>" class="btn btn-danger" title="Inactive Now"><i class="fa fa-arrow-down"></i> </a>
			<?php else: ?>
				<a href="<?php echo e(route('cproduct.active',$item->id)); ?>" class="btn btn-success" title="Active Now"><i class="fa fa-arrow-up"></i> </a>
			<?php endif; ?>
		</td>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sortiment/resources/views/backend/customize_product/list.blade.php ENDPATH**/ ?>