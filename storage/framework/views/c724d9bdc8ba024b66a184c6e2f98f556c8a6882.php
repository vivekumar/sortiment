...
<head>
    ...
    <title><?php echo e(__('Order Processing')); ?></title>
</head>
                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        <td style="font-size: 30px; font-weight: 600; color: #ffffff; padding-bottom: 15px;">
                            <?php echo e(__('Order is being processed')); ?>

                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            <?php echo e(__('We are now processing your order')); ?> - <?php echo e(__('you will receive an email every time your order goes to the next step in the process')); ?>.
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 0 5px;"><img src="<?php echo e($message->embed('public/frontend/mail/img/people-carry-solid.png')); ?>" width="20" alt=""></td>
                                                <td><p><strong><?php echo e(__('Order Processed')); ?></strong><br> <small><?php echo e(__('We are preparing your order')); ?>.</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/order-processing.blade.php ENDPATH**/ ?>