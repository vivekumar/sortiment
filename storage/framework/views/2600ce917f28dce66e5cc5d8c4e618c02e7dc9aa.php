...
<head>
    ...
    <title><?php echo e(__('Payment Received')); ?></title>
</head>
            ...
            <td colspan="3">
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        ...
                        <?php echo e(__('Payment received')); ?>

                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            <?php echo e(__('We have now received your payment')); ?>
                    ...
                    <tr>
                        <td style="padding-right:10px">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td valign="top">
                                        <img src="<?php echo e($message->embed('public/'.\App\Models\CustomizeProduct::where('id',$items['product_id'])->value('product_thambnail') )); ?>"  alt="" style="height:150px; width: auto; margin-right:10px">
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 0 5px;"><img src="<?php echo e($message->embed('public/frontend/mail/img/money-check-solid.png')); ?>" width="20" alt=""></td>
                                                <td><p><strong><?php echo e(__('Payment confirmed')); ?></strong><br> <small><?php echo e(__('Payment received')); ?></small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/payment-received.blade.php ENDPATH**/ ?>