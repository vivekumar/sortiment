								  ...
								  <div class="row">
									...
									<div class="col-6">
									 <div class="fog-pwd text-right">
										<a href="<?php echo e(route('password.request')); ?>" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot pwd?</a><br>
									  </div>
									</div>
									<!-- /.col -->
...
<?php /**PATH /var/www/html/sortiment/resources/views/auth/admin_login.blade.php ENDPATH**/ ?>