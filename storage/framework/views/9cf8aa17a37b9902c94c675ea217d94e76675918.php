		...
		<div class="row">
            <div class="col-8">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(__('Brand List')); ?></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
            ...
            <div class="col-md-4">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo e(__('Add Brand')); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5><?php echo e(__('Brand Name')); ?> <span class="text-danger">*</span></h5>
                                        <div class="controls">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/sortiment/resources/views/backend/brand/view.blade.php ENDPATH**/ ?>