                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            <?php echo e(('We have now received your information.')); ?>
                ...
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(!empty($details['label'])): ?><p style="font-size: 16px;"><strong style="font-size: 24px;"><?php echo e(__('Label')); ?>:</strong> <?php echo e($details['label']); ?></p><?php endif; ?>
                            <?php if(!empty($details['color'])): ?><p style="font-size: 16px;"><strong style="font-size: 24px;"><?php echo e(__('Color')); ?>:</strong> <?php echo e($details['color']); ?></p><?php endif; ?>
                            <?php if(!empty($details['size'])): ?><p style="font-size: 16px;"><strong style="font-size: 24px;"><?php echo e(__('Size')); ?>:</strong> <?php echo e($details['size']); ?></p><?php endif; ?>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tfoot style="background-color: #f3f3f3;">
            <tr>
                ...
                <td style="padding-right: 15px; padding-left: 15px; width: 50%;">
                    ...
                    <p style="margin: 0;">“<?php echo e($details['company_user_name']); ?>” is ready to answer your questions</p>
                </td>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/product-information-confirmed.blade.php ENDPATH**/ ?>