...
<?php endif; ?>
                <div class="row">
                  ...
                  <div class="col-lg-6 input-row mb-4">
                      <span class="input-icon"><img src="<?php echo e(asset('frontend/assets/img/users-solid.png')); ?>" alt="" width="25"></span>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/auth/register.blade.php ENDPATH**/ ?>