        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h2 class="box-title">Chat Inbox</h2>
                </div>
                <!-- /.box-header -->
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sortiment/resources/views/admin/question/chat.blade.php ENDPATH**/ ?>