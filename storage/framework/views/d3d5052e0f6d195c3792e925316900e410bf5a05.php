    ...
    <div class="products-con1 ask-qus-wrap d-flex">
        <div class="chat-wrap">
            <div class="welcome-chat text-center">
                <p><?php echo e(__('Welcome to Sortiment LiveChat')); ?>. <?php echo e(__('Please choose one of the following questions or write your own')); ?></p>
            </div><!-- Welcome chat -->
            ...
            <div class="chat-foot" id="chat-foot">
                <div action="" class=" d-flex justify-content-between">
                    <input type="text" class="form-control" placeholder="<?php echo e(__('Write your message here')); ?>" id="chatInput">
                    <a onclick="sendAttachment()" class="btn btn-blue attach-file"><i class="fas fa-images"></i></a>
                    <button type="button" class="btn btn-blue send-msg-btn" id="send-button"><?php echo e(__('Send message')); ?> <i class="fas fa-paper-plane"></i></button>
                </div>
            </div><!-- Chat footer -->
    ...
    <script type="text/javascript">
        (() => {
            ...
            sendMessage = (message, attachment = 0) => {
                ...
                msg_html += '<img src="<?php echo e(asset($user->profile_photo_path)); ?>" class="user-img" alt="" width="50">';
            ...
            socket.on('sendChatToClient', (msgArr) => {
                for (let c in msgArr) {
                    ...
                    if (chat.user_id == <?php echo e($user->id); ?> && chat.admin_id == <?php echo e($admin->id); ?>) {
                        let chat_body = document.getElementById('chat-body');
                        let chat_element = document.createElement('li');
...
<?php echo $__env->make('company.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/sortiment/resources/views/company/ask-question-form.blade.php ENDPATH**/ ?>