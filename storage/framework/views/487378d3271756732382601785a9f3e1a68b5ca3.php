            ...
            <td colspan="3">
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        ...
                        Din virksomhed <?php echo e($details['company']); ?> har oprettet en bruger til dig på sortiment shoppen. Log ind for at se om din virksomhed har tildelt dig nogle produkter som mangler dine informationer
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        <td style="font-size: 30px; font-weight: 700; padding-bottom: 5px;">Dine kontooplysninger</td>
                    </tr>
                    <tr>
                        <td colspan="3">
                                ...
                                <tr>
                                    <td>
                                        <div class="input-row"  style="position: relative;">
                                            <span style="margin-bottom:10px;display: block;"><img src="http://50.116.13.170/sortiment/frontend/assets/img/user-solid.png" alt="" width="25"> Brugernavn</span>
                                    ...
                                    <td>
                                        <div class="input-row" style="position: relative;">
                                            <span style="margin-bottom:10px;display: block;"><img src="http://50.116.13.170/sortiment/frontend/assets/img/key-solid.png" alt="" width="25"> Kodeord</span>

                                            <input type="text" name="password" value="<?php echo e($details['password']); ?>"
                                            style="height: 42px;
                                            width: 85%;
                                            border-radius: 7px;
                                            background: rgba(0, 31, 209, 0.1);
                    ...
                    <tr>
                        <td>
                            <a href="<?php echo e(route('employee-login')); ?>" style="width: 100%; background-color: #001FD1; color: #ffffff; padding-top: 20px; padding-bottom: 20px; font-size: 25px; font-weight: 600; border-radius: 5px; margin-top: 15px; display: block; text-decoration: none; text-align: center;">Log ind her</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tfoot style="background-color: #f3f3f3;">
            <tr>
                ...
                <td style="padding-right: 15px; padding-left: 15px; width: 50%;">
                    <h2 style="color: #001FD1; font-size: 30px; font-weight: bold; margin: 0 0 10px;">Har du nogle spørgsmål?</h2>
                    <p style="margin: 0;">Rasmus sidder klar til at hjælpe dig.</p>
                </td>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/login.blade.php ENDPATH**/ ?>