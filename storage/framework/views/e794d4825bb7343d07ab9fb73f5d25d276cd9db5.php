        ...
        <div class="form-wrapper row">
            <div class="col-md-5 left-col d-flex align-items-center flex-column justify-content-between">
                ...
                <div class="mid-col text-center">
                    <a href="<?php echo e(route('login')); ?>" class="btn bdr-btn">Log in</a>
                    <p><a href="<?php echo e(route('register')); ?>"><strong>Dont have an account yet? </strong></a>Please register with the formular to the right</p>
                </div><!-- Middle col -->
...
<?php endif; ?>
                <div class="row">
                  <div class="col-lg-6 input-row mb-4">
                    ...
                    <input type="text" class="form-control required" placeholder="Name and lastname" name="name" :value="old('name')" required autofocus autocomplete="name" >
                  </div>
                  <div class="col-lg-6 input-row mb-4">
                  ...
                  <div class="col-lg-6 input-row mb-4">
                    ...
                    <input type="email" name="email" :value="old('email')" required class="form-control required" placeholder="Email">
                  </div>
                  <div class="col-lg-6 input-row  mb-4">
                  ...
                  <div class="col-lg-6 input-row mb-4">
                    ...
                    <input type="password" name="password" required autocomplete="new-password" class="form-control required" placeholder="Password">
                  </div>
                  <div class="col-lg-6 input-row mb-4">
                    <!--<?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>-->
                    <span class="input-icon"><img src="<?php echo e(asset('frontend/assets/img/key-solid.png')); ?>" alt="" width="25"></span>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'password_confirmation','class' => 'block mt-1 w-full form-control','type' => 'password','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password','placeholder' => 'Confirm Password']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'password_confirmation','class' => 'block mt-1 w-full form-control','type' => 'password','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password','placeholder' => 'Confirm Password']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
                  ...
                  <div class="col-lg-6 input-row  mb-5">
                      <span class="input-icon"><img src="<?php echo e(asset('frontend/assets/img/key-solid.png')); ?>" alt="" width="25"></span>
                    <input type="text" name="crv_number" class="form-control required" placeholder="CVR Number">
                  </div>
                  <div class="col-sm-12 btn-row">
                      <button type="submit" class="btn btn-blue f-width toggle-disabled" disabled>Create account</button>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/sortiment/resources/views/auth/register.blade.php ENDPATH**/ ?>