                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            <?php echo e(__('Your order has now been delivered')); ?>. <?php echo e(__('If you could please fill out a survey explaining your experience with our service, we would very much appreciate it.')); ?>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 15px; width: 100%;">
                    <tr>
                        <td colspan="3" style="text-align: center; padding-bottom: 70px;">
                            <p style="font-size: 20px; line-height: 28px;"><?php echo e(__('Care to take 10 minutes explaining your experience using our service')); ?>? <?php echo e(__('This will help us improve our website and services going further.')); ?></p>
                            <a href="https://dk.trustpilot.com/review/sortiment.dk" style="background-color: #001FD1; color: #ffffff;display: inline-block; border-radius: 5px; text-decoration: none; text-align: center; vertical-align: top; font-size: 20px;width: 300px; padding: 15px 25px;"><?php echo e(__('Rate our service')); ?></a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-right:10px">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td valign="top">
                                        <img src="<?php echo e($message->embed('public/'.\App\Models\CustomizeProduct::where('id',$items['product_id'])->value('product_thambnail') )); ?>" style="height:150px; width: auto; margin-right:10px" alt="">
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 0 5px;"><img src="<?php echo e($message->embed('public/frontend/mail/img/shipping-fast-solid.png')); ?>" width="20" alt=""></td>
                                                <td><p><strong><?php echo e(__('Order shipped')); ?></strong><br> <small><?php echo e(__('Your order has been shipped')); ?>.</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td> <p><strong style="margin-bottom:5px;display:inline-block;"><?php echo e($order['order_recieved_date']); ?></strong>
                                    <?php if(!empty($order['pdf'])): ?>
                                    
                                    <a href="<?php echo e(asset($order['pdf'])); ?>" style="background-color: #001FD1; display: inline-block; padding: 5px 15px; border-radius: 5px; text-align: center;"><img src="<?php echo e($message->embed('public/frontend/mail/img/file-pdf-solid.png')); ?>" alt="" width="20" download></a>
                                    <?php endif; ?>
                                    </p>
                                    </td>
                                </tr>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/mail/order-completed.blade.php ENDPATH**/ ?>