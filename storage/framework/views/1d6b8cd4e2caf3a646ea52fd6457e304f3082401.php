		...
		<div class="row">
            <div class="col-8">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(__('Attribute List')); ?></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('attribute.edit',$attribute->id)); ?>" class="btn btn-circle btn-info btn-sm mb-5" title="Edit"><i class="fa fa-edit" aria-hidden="true" style="font-size:1rem"></i></a><a href="<?php echo e(route('all.attributeval',$attribute->id)); ?>" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-arrow-right"></span></a></td>
            ...
            <div class="col-md-4">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo e(__('Add Attribute')); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\sortiment\resources\views/backend/attribute/view.blade.php ENDPATH**/ ?>