...
<body>
    ...
    <page size="A4">
        ...
        <div class="img-style">
            <img src="<?php echo e(asset($product->product_thambnail)); ?>" class="img-full" alt="">
        </div>
        ...
        <div class="center"><img src="<?php echo e(asset('frontend/assets/img/sortiment-logo.png')); ?>" alt="" class="img-logo"></div>
    ...
    <?php $__currentLoopData = $product->mutimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mulimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <page size="A4">
        <p><strong>Kunde: </strong>Infocon</p>
        <p><strong>Produkt: </strong>T-time t-shirt</p>
        <p><strong>Efterbehandling: </strong>Tryk</p>
        ...
        <div class="img-style">
            <img src="<?php echo e(asset($mulimg->photo_name)); ?>" class="img-full">
        </div>
...
<?php /**PATH /var/www/html/laravel/sortiment/resources/views/pdf/imagepdf.blade.php ENDPATH**/ ?>