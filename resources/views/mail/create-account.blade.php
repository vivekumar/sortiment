                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            You have recently created an account on Sortiment.dk - please confirm your account, so you are ready to order products from our site!
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        <td style="font-size: 30px; font-weight: 700; padding-bottom: 5px;">Your account information</td>
                    </tr>
                    <tr>
                        <td>
                            <a href="#" style="width: 100%; background-color: #001FD1; color: #ffffff; padding-top: 20px; padding-bottom: 20px; font-size: 25px; font-weight: 600; border-radius: 5px; margin-top: 15px; display: block; text-decoration: none; text-align: center;">Confirm account</a>
                        </td>
                    </tr>
                </table>
            </td>
