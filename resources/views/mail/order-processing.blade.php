...
<head>
    ...
    <title>{{__('Order Processing')}}</title>
    <style>
                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        <td class="fs-20" style="font-size: 30px; font-weight: 600; color: #ffffff; padding-bottom: 15px;">
                            {{__('Order is being processed')}}
                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            {{__('We are now processing your order')}} - {{__('you will receive an email every time your order goes to the next step in the process')}}.
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 0 5px;"><img src="{{ $message->embed('public/frontend/mail/img/people-carry-solid.png')}}" width="20" alt=""></td>
                                                <td><p><strong>{{__('Order Processed')}}</strong><br> <small>{{__('We are preparing your order.')}}</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
