                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            {{__('Your order has now been delivered')}}. {{__('If you could please fill out a survey explaining your experience with our service, we would very much appreciate it.')}}
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
                ...
                <table style="padding: 50px 15px; width: 100%;">
                    <tr>
                        <td colspan="3" style="text-align: center; padding-bottom: 70px;">
                            <p style="font-size: 20px; line-height: 28px;">{{__('Care to take 10 minutes explaining your experience using our service')}}? {{__('This will help us improve our website and services going further.')}}</p>
                            <a href="https://dk.trustpilot.com/review/sortiment.dk" style="background-color: #001FD1; color: #ffffff;display: inline-block; border-radius: 5px; text-decoration: none; text-align: center; vertical-align: top; font-size: 20px;width: 300px; padding: 15px 25px;">{{__('Rate our service')}}</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <p><strong style="font-size: 18px;"><small style="color: #001FD1; font-size: 18px;">{{__('Total price')}}:</small> @php $totalAmt=$order['amount']+$order['delivery_costs'];@endphp {{$formatter->formatCurrency($totalAmt, 'DKK'), PHP_EOL;}}</strong></p>
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td><p><strong>{{__('Order shipped')}}</strong><br> <small>{{__('Your order has been shipped')}}.</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td> <p><strong style="margin-bottom:5px;display:inline-block;">{{$order['order_recieved_date']}}</strong>
                                    @if(!empty($order['pdf']))
                                    {{-- route('download.invoice',$order['id'])--}}
                                    <a href="{{ asset($order['pdf'])}}" style="background-color: #001FD1; display: inline-block; padding: 5px 15px; border-radius: 5px; text-align: center;"><img src="{{ $message->embed('public/frontend/mail/img/file-pdf-solid.png')}}" alt="" width="20" download></a>
                                    @endif
                                    </p>
                                    </td>
                                </tr>
