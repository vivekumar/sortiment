            ...
            <td colspan="3">
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        ...
                        Vi har modtaget din forspørgsel på {{$details['product_name']}}. Et tilbud og produkt er nu ved at blive oprettet og du vil derfor modtage en email indenfor 24 timer, så snart dit produkt ligger klar på din profil.
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        <td colspan="3" style="font-size: 30px; font-weight: 700; padding-bottom: 30px;">{{$details['product_name']}}</td>
                    </tr>
                    <tr>
                        <td valign="top">
                            <img src="{{ $message->embed('public/'.$details['product_thambnail'])}}" style="height:150px; width: auto; margin-right:10px" alt="">
                        </td>
                        <td style="width: 70%;">
                            <table style="width: 100%;">
                                <tr>
                                    <td valign="top" style="padding:10px;">{{__('Do you want your logo on the product')}}?</td>
                                    <td style="text-align: right; font-weight: bold; padding:10px;">@if($details['logo_on_product']==1) {{__('Yes')}} @else {{__('No')}} @endif</td>
                                </tr>
                                @if($details['logo_on_product']==1)
                                <tr>
                                    <td valign="top" style="padding:10px;">Logo position</td>
                                    <td style="text-align: right; font-weight: bold; padding:10px;">
                                        @if(!empty($details['logo_value'])) {{str_replace('|',',',$details['logo_value'])}} @endif
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right; font-weight: bold; padding:10px;">@if($details['text_on_product']==1) {{__('Yes')}} @else {{__('No')}} @endif</td>
                                </tr>
                                @if($details['text_on_product']==1)
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px; font-size: 13px; width: 60%;">{{$details['message']}}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
