                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            {{__('Du har fornylig oprettet en konto på Sortiment.dk - din konto er nu godkendt og du kan nu bestille produkter via shoppen.')}}
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
        ...
        <tr>
            <td colspan="3">
                <table style="padding: 50px 30px; width: 100%;">
                    ...
                    <tr>
                        <td>
                            <a href="{{url('/')}}" style="width: 100%; background-color: #001FD1; color: #ffffff; padding-top: 20px; padding-bottom: 20px; font-size: 25px; font-weight: 600; border-radius: 5px; margin-top: 15px; display: block; text-decoration: none; text-align: center;">{{__('Log ind')}}</a>
                        </td>
                    </tr>
                </table>
            </td>
