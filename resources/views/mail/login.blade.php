            ...
            <td colspan="3">
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        ...
                        Din virksomhed {{$details['company']}} har oprettet en bruger til dig på sortiment shoppen. Log ind for at se om din virksomhed har tildelt dig nogle produkter som mangler dine informationer
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
        ...
        <tfoot style="background-color: #f3f3f3;">
            <tr>
                ...
                <td style="padding-right: 15px; padding-left: 15px; width: 50%;">
                    <h2 class="fs-20" style="color: #001FD1; font-size: 30px; font-weight: bold; margin: 0 0 10px;">Har du nogle spørgsmål?</h2>
