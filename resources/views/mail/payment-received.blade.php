                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    ...
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            {{__('We have now received your payment')}}
                        </td>
                    </tr>
                </table><!-- banner -->
            </td>
                    ...
                    <tr>
                        <td style="padding-right:10px">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td valign="top">
                                        <img src="{{ $message->embed('public/'.\App\Models\CustomizeProduct::where('id',$items['product_id'])->value('product_thambnail') )}}"  alt="" style="height:150px; width: auto; margin-right:10px">
                                    ...
                                    <td>
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 0 5px;"><img src="{{ $message->embed('public/frontend/mail/img/money-check-solid.png')}}" width="20" alt=""></td>
                                                <td><p><strong>{{__('Payment confirmed')}}</strong><br> <small>{{__('Payment received')}}</small></p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
