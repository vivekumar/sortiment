    ...
    <div id="main-wrapper">
        ...
        <div class="col-md-5 left-col d-flex align-items-center flex-column justify-content-between">
                ...
                <div class="mid-col text-center">
                    ...
                    <p><a href="{{route('login')}}"><strong>{{__('Already have an account?')}} </strong></a></p>--}}
                </div><!-- Middle col -->
                <div class="bot-col text-center">
                    <p>{{__('If you have any questions please contact Sortiment using')}} <strong>b2b@sortiment.dk  eller tlf. +45 41 88 80 80</strong></p>
                </div><!-- Bottom col -->
            </div><!-- left col -->
