...
$(document).ready(function () {
        ...
        $('#product-zoom-model').on('show.bs.modal', function (e) {
        	
            var image = $(e.relatedTarget).attr('src');
            
            $("#big-popup .owl-item.active img._9gag").attr("src", image);
...
//   if {
//     document.getElementById('big').classList.add("custom");
//     document.getElementById('product-zoom-model').classList.add("custom");
//   } else {
//     document.getElementById('big').classList.remove("custom");
//     document.getElementById('product-zoom-model').classList.remove("custom");
//   }
// }
...
// ============POPUP CODE END=================
    ...
    function syncPosition(el) {
        ...
        thumbs
            ...
            .eq(current)
            .addClass("current");
        var onscreen = thumbs.find(".owl-item.active").length - 0;
        var start = thumbs
