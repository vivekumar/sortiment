...
<style>
 ...
 <!-- Plugin CSS -->
 <link rel="stylesheet" type="text/css" href="{{asset('frontend/product-slider/vendor/photoswipe/photoswipe.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/product-slider/vendor/photoswipe/default-skin/default-skin.min.css')}}">
    <!-- Swiper CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/product-slider/vendor/swiper/swiper-bundle.min.css')}}">

    <!-- Default CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/product-slider/css/style.min.css')}}">
                        ...
                        <div class="swiper-container product-single-swiper swiper-theme nav-inner"
                            ...
                            <div class="swiper-wrapper row cols-1 gutter-no">
                                <div class="swiper-slide">
                                    <figure class="product-image">
                                        <img src="{{asset($product->product_thambnail) }}"
                                            data-zoom-image="{{asset($product->product_thambnail) }}"
                                            alt="" width="800"
                                            height="900">
                                    </figure>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <figure class="product-image">
                                        <img src="{{asset($mutimage->photo_name) }}"
                                            data-zoom-image="{{asset($mutimage->photo_name) }}"
                                            alt="" width="488"
                                            height="549">
                                    </figure>
                                </div>
...
<!-- =========Model Code Start============ -->
        ...
        <div class="col-lg-5 col-md-12">
            <div class="product-info">
                ...
                <div class="price">Pris fra:  {{$formatter->formatCurrency(round($product->product_price), 'DKK'), PHP_EOL;}} </div>
...
<div class="modal fade" id="priceModal" role="dialog" aria-labelledby="priceModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @csrf
                @if($product->logo_on_product==1 && !empty($product->logo_value))
                <div class="form-row mb-3 ">
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 col-sm-12 filed-group d-flex justify-content-end">
                            <label for="noRadio">
                                <input class="form-check-input" id="noRadio" type="radio" name="logo_on_product" value="0" checked> {{__('No')}}
                            </label>
                            <label for="yesRadio">
                        ...
                        <div class="col-md-6 col-sm-12 filed-group d-flex justify-content-end">
                            <div class="form-check d-flex flex-wrap">
                                ...
                                <div class="d-flex align-items-center col-md-6">
                                    <input class="form-check-input" type="checkbox" id="check{{$key}}" name="logo_value[]" value="{{$logoposition}}">
                ...
                @endif
                @if($product->text_on_product==1 && !empty($product->text_value))
                <div class="form-row mb-3 ">
                    <div class="row form-group">
                        <label for="" class="col-md-6 col-sm-12 col-form-label">{{__('Do you want to assign a text to the product')}}?</label>
                        <div class="col-md-6 col-sm-12 filed-group d-flex justify-content-end">
                            <label for="noRadio2">
                                <input class="form-check-input" id="noRadio2" type="radio" name="text_on_product" value="0" checked> {{__('No')}}
                            </label>
                            <label for="yesRadio2">
                    ...
                    <div class="row form-group textOnP hide" >
                        ...
                        <div class="col-md-6 col-sm-12 filed-group d-flex justify-content-end">
                            <div class="form-check d-flex flex-wrap">
                                ...
                                @foreach($arraylogoposition as $key=>$logoposition)
                                <div class="d-flex align-items-center col-md-6">
                                    <input class="form-check-input" type="checkbox" id="check1{{$key}}" name="text_value[]" value="{{$logoposition}}">
                                    <label class="form-check-label" for="check1{{$key}}">
                                        {{$logoposition}}
                                    </label>
                                </div><!-- div -->
                                @endforeach
                    ...
                    <div class="sec_logo">
                        ...
                        <div class="sec-logo-flex">
                            ...
                            <div class="custom_logo">
                                <input type="radio" name="profile_logo" data-waschecked="false" id="cb{{$allimage->id}}" value="{{$allimage->image}}" />
...
<script src="{{asset('frontend/product-slider/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('frontend/product-slider/vendor/zoom/jquery.zoom.js')}}"></script>
    <script src="{{asset('frontend/product-slider/vendor/photoswipe/photoswipe.min.js')}}"></script>
    <script src="{{asset('frontend/product-slider/vendor/photoswipe/photoswipe-ui-default.min.js')}}"></script>

    <!-- Swiper JS File -->
    <script src="{{asset('frontend/product-slider/vendor/swiper/swiper-bundle.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('frontend/product-slider/js/main.min.js')}}"></script>
<script>
    $(function(){
