...
<head>
    ...
    <title>{{__('Product Information')}}</title>
</head>
                ...
                <table style="width: 100%; text-align: center; background-color: #001FD1; padding: 20px;">
                    <tr>
                        <td style="font-size: 30px; font-weight: 600; color: #ffffff; padding-bottom: 15px;">
                            {{__('We need your information')}}
                        </td>
                    </tr>
                    <tr>
                        <td style="color: #ffffff; font-size: 17px;">
                            Din virksomhed har nu bestilt produkter på {{$details['company']}} og du skal nu derfor vælge dine præferencer på produktet.
                ...
                <table style="padding: 50px 30px; width: 100%;">
                    <tr>
                        <td style="">
                            ...
                            <!--<img src="{{ $message->embed('public/frontend/mail/img/product-img-back.jpg')}}" width="150px" alt="">-->
                        </td>
                        <td>
                            <h1>{{$details['name']}}</h1>
                            <p style="font-size: 16px;"><strong style="font-size: 24px;">{{__('Size')}}:</strong> {{__('Your size')}}</p>
                            <a href="#" style="background-color: #001FD1;color: #ffffff;display: inline-block;padding: 10px 20px;border-radius: 5px;text-decoration: none;">{{__('Fill out product information')}}</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tfoot style="background-color: #f3f3f3;">
            <tr>
                ...
                <td style="padding-right: 15px; padding-left: 15px; width: 50%;">
                    ...
                    <p style="margin: 0;">“{{$details['company_user_name']}}” is ready to answer your questions</p>
                </td>
